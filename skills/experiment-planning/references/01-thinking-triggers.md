...
Concise reasoning triggers for ML experiment moments. Use the trigger that matches your situation — each is a 1-2 sentence activation, not a full framework.
