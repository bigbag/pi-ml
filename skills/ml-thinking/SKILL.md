---
description: Reasoning triggers for ML research — short mental model activations for debugging training issues, questioning assumptions, and validating results.
---
...
**Margin of safety trigger:** What's the noise floor? How many runs to prove this delta? Never claim a gain smaller than your run-to-run variance. Use `binomialExactTwoSided(k, n)` from stats module for significance. If you can't show p<0.05, it's directional at best.
